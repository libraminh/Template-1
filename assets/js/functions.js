...
function designHover() {
  var setBgColor = function(dataKey) {
    var $this = $(this);
    $this.parent().parent().css('background-color', $this.data(dataKey));
  };

  $('.design-img-link').hover(function(){
    setBgColor.call(this, 'color');
  }, function(){
    setBgColor.call(this, 'origin');
  })
}
...
function youtubeVidScroll() {
  ...
  $('.video-strip').css({
    'background-position' : 'center -'+ wScroll/1.5 +'px'
  })
}
